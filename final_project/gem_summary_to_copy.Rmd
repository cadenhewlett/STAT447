...
A higher $\alpha$ indicates less confidence in the base measure, yielding greater dispersion and a higher number of clusters of measures about $\mathbb{G}_0$. Conversely, a lower $\alpha$ indicates more confidence in $\mathbb{G}_0$ resulting in fewer, larger clusters. [@Sethuraman1994]. The finite approximation of this property can be seen in Figure 1. 
