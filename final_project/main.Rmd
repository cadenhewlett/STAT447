...
Before we continue to discuss Dirichlet Distributions and Processess, we note to the reader that the definitions above are quite general, and can be rather abstract for those unfamiliar with measure theory. To reinforce the properties discussed above, we present worked examples of proving a set to be a $\sigma$-algebra and verifying a probability measure $\upmu$ in the Appendix. 
