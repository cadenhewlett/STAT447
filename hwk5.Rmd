...
$$
\mathbb{E}(Y\mid p =p_{\text{obs}}) = \sum_{\{y\, : \,\uppi(y) > 0 \}}y\,\uppi(y)
$$
From our "original" coin flip example, we'd have $K=2$ and
$$
\mathbb{E}(Y\mid p_{\text{obs}}) = \Big(\dfrac{1}{K}\Big) \pi(1) + \Big(\dfrac{2}{K}\Big) \pi(2) = \Big(\dfrac{1}{2}\Big)\cdot\dfrac{1}{17} + \Big(\dfrac{2}{2}\Big) \dfrac{16}{17} = \frac{33}{34}
$$
