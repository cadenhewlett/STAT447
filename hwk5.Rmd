...
So, in this case, the $7$th column
...
notes before I gtg break
- slope is greater than zero (and nearly zero)
- implies that increasing sample size has neglible effect on the error between ptrue and simulated values (E[p given data])
- makes sense, since rho post and rho true are in fact the same
- perhaps produce a plot of means as well as error bands (also inspect non loglog)
- oh shit tyto is messaging me
