...
$$
\vec\beta = \Big\{ \beta_i \mid \beta_i \sim N(0,1), \text{ for } i \in [1, n_{\text{pred}}]\Big\}
$$

$$
\vec{\mathbf{y}}\mid \vec{\beta} \,\sim\text{bern}\Big( \text{logistic}\big(\mathbf{X}^{\top} \vec{\beta} \,\big) \Big)
$$
