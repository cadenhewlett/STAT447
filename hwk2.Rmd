...
Let's first approach this problem by making a table designating potential losses based on outcomes. Here we let the numbers be in millions of dollars.

\begin{table}[h]
\centering
\begin{tabular}{l|m{3cm}|m{3cm}|m{3cm}|}
          & $y = 1$ & $y = 0$ \\ \hline
$a = 1$ & Loss of \textbf{2}. You don't get your insurance deposit back. & Loss of \textbf{-100}. The rocket crashes and you get your money back. \\ \hline
...
$$
L(a,y) = 2 \mathbb{I}(a = 1, y = 1) + 0 \mathbb{I}\big(a = 0, y = 1) - 100 \mathbb{I}\big(a = 1, y = 0) + 100 \mathbb{I}\big(a = 0, y = 0)
$$
Which simplifies to:
$$
L(a,y) = 2 \big(\mathbb{I}(a = 1)\mathbb{I}(y = 1)\big) -100 \big(\mathbb{I}(a = 1)\mathbb{I}(y = 0)\big) + 100 \big(\mathbb{I}(a = 0)\mathbb{I}(y = 0)\big)
$$